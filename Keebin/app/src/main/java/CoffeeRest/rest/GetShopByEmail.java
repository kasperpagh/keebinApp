...
public class GetShopByEmail extends AsyncTask<String, Void, String>
{
    ...
    public GetShopByEmail(String baseUrl, String email, AsyncResponse delegate, Context context)
    {
    ...
    private String getShop() throws IOException
    {
        ...
        try
        {
            URL url = new URL(baseUrl + "coffee/shop/" + email);
